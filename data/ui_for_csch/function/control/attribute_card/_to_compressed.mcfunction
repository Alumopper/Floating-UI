...
data modify storage floating_ui:input animate.data set from storage floating_ui:data anim.'csch:attribute_card'.to_compressed_attr_value
...
data modify storage floating_ui:input animate.data set from storage floating_ui:data anim.'csch:attribute_card'.to_compressed_attr_title
