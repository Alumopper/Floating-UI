...
data modify entity @s interpolation_duration set from entity @s item.tag.data.ui.anim.move_out.time
execute if data entity @s item.tag.data.ui.anim.move_out.delay run data modify entity @s start_interpolation set from entity @s item.tag.data.ui.anim.move_out.delay
execute unless data entity @s item.tag.data.ui.anim.move_out.delay run data modify entity @s start_interpolation set value 0
...
#事件队列
execute unless data entity @s item.tag.data.ui.anim.move_out.end run return 0
