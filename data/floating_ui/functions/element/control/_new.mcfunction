...
execute at @s as 1bf52-0-0-0-2 on origin if entity @s[type=marker] run data modify entity @s data.size set from entity @e[tag=new,limit=1] transformation.scale
