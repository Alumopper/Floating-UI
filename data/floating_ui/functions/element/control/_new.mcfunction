...
execute at @s as 0-0-0-0-2 on origin if entity @s[tag=floating_ui_root] run data modify entity @s data.size set from entity @e[tag=new,limit=1] transformation.scale
