...
execute store result score move.x _ run data get storage floating_ui:input move 10000.0
execute store result score move.y _ run data get storage floating_ui:input move 10000.0
