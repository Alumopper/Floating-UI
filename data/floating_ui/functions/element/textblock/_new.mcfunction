...
execute store result entity @s data.size[0] float 0.024 as 1bf52-0-0-0-4 on origin run data get entity @s line_width
...
execute store result entity @s data.size[1] float 0.0001 run scoreboard players get line _
#居中
execute store result score text_y _ run data get entity @s data.size[1] 5000
scoreboard players operation root_y _ = @s floating_ui.root_y
execute as 1bf52-0-0-0-4 on origin store result entity @s transformation.translation[1] float 0.0001 run scoreboard players operation root_y _ -= text_y _
