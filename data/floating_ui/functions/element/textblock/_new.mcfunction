...
execute unless score hasNewAnim _ matches 1 as 0-0-0-0-4 on origin run data modify storage floating_ui:input temp.anim.new.value[0].value set from storage floating_ui:input temp.fontsize
