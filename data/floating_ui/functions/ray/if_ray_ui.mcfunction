...
#开始求最近交点
execute as @e[type=marker,tag=floating_ui_root,sort=furthest] if score @s floating_ui.uid = @p[tag=floating_ui_curr] floating_ui.uid run function floating_ui:ray/move/root_check_point
