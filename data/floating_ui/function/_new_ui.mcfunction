...
execute store result score @s floating_ui.u run data get entity @s item.components.minecraft:custom_data.x
execute store result score @s floating_ui.v run data get entity @s item.components.minecraft:custom_data.y
