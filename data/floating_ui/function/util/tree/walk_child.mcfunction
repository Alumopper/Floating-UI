...
data modify entity 1bf52-0-0-0-2 Thrower set from storage floating_ui:temp next.child[0][0]
execute as 1bf52-0-0-0-2 on origin run function floating_ui:util/tree/next with storage floating_ui:temp arg
