...
execute as @e[tag=floating_ui_root,distance=..20] if score test _ matches 0 store success score test _ if score @s floating_ui.uid = @p[tag=floating_ui_owner] floating_ui.uid
