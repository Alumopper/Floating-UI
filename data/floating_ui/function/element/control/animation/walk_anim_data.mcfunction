...
execute if score isTo floating_ui.temp matches 0 run function floating_ui:element/control/animation/get_target_value with storage floating_ui:temp arg
...
execute if score isProperty floating_ui.temp matches 1 run function floating_ui:element/control/animation/property_set with storage floating_ui:temp arg
