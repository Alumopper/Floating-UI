...
execute if score return _ matches 1 unless data storage floating_ui:temp child[-1][0].size run function floating_ui:element/control/auto_layout/get_child_size