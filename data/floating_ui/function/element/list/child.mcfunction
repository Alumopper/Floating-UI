...
scoreboard players operation @s floating_ui.list.childCount = temp.childCount floating_ui.temp 

#初次更新列表中的内容
scoreboard players set @s floating_ui.list.index 0
scoreboard players set selected_index floating_ui.temp 0
scoreboard players set @s floating_ui.list.maxIndex 1
scoreboard players set @s floating_ui.list.minIndex 0
execute on passengers unless score @s floating_ui.list.childIndex = selected_index floating_ui.temp run function floating_ui:element/list/update_e_view/change_size
