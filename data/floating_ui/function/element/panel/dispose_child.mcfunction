...
function floating_ui:dispose_control with entity @s item.components.minecraft:custom_data.data.ui.child[0]
data remove entity @s item.components.minecraft:custom_data.data.childPoint[0]
data remove entity @s item.components.minecraft:custom_data.data.ui.child[0]
