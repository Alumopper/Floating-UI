...
#update the value
scoreboard players operation qwq floating_ui.temp = @s floating_ui.numberbox.value
execute store result score value floating_ui.temp run scoreboard players operation qwq floating_ui.temp -= value floating_ui.temp
