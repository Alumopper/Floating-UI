...
execute if score isTo floating_ui.temp matches 0 on passengers run function floating_ui:element/textcontrol/animation/get_target_value with storage floating_ui:temp arg
...
execute if score isProperty floating_ui.temp matches 1 on passengers run function floating_ui:element/textcontrol/animation/property_set with storage floating_ui:temp arg
execute unless score isProperty floating_ui.temp matches 1 on passengers run function floating_ui:element/textcontrol/animation/data_set
