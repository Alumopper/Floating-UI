...
execute on passengers if entity @s[type=text_display] store result entity @s transformation.scale[0] float 0.000001 run scoreboard players get temp.size0 floating_ui.temp
execute on passengers if entity @s[type=text_display] store result entity @s transformation.scale[1] float 0.000001 run scoreboard players get temp.size0 floating_ui.temp
